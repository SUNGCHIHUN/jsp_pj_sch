...
<div id="header">
	<nav class="menu_bar1">
		<ul class="menu1">
			...
			<li><a href="${path}/board_list.do?board_category=notice">공지사항</a></li>
			<li><a href="${path}/board_list.do?board_category=ask">문의사항</a></li>
		</ul>
		<ul class="menu2">
	...
	<nav class="menu_bar2">
		<ul class="menu3">
			...
			<li><a href="${path}/product_list.do?product_category=energy"><img src="${path}/resources/images/navImage/energy-drink-100.png" alt="드링크"></a></li>
			<li><a href="${path}/product_list.do?product_category=carbon"><img src="${path}/resources/images/navImage/cold-drink-100.png" alt="탄산"></a></li>
			<li><a href="${path}/product_list.do?product_category=water"><img src="${path}/resources/images/navImage/sparkling-water-100.png" alt="생수"></a></li>
			<li><a href="${path}/product_list.do?product_category=coffee"><img src="${path}/resources/images/navImage/coffee-100.png" alt="커피"></a></li>
		</ul>
	</nav>
</div>
</body>
