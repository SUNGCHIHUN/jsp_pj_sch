...
<body>
	...
	<div id="container">
		...
		<%@ include file="/manager/common/left_menu.jsp" %>
			<!-- 오른쪽 컨텐츠 -->
			<div id="section">
				<form action="${path}/stock_update_action.ad" method="post">
					<table>
						<tr>
							<th>상품명</th>
							<td><input type="text" class="inputBox" name="p_name" value=""></td>
						</tr>
						<tr>
							<th>카테고리</th>
							<td>
						...
						<tr>
							<th>상품가격</th>
							<td><input type="number" class="inputBox" name="p_price" value=""></td>
						</tr>
						<tr>
							<th>상품수량</th>
							<td><input type="number" class="inputBox" name="p_amount" value=""></td>
						</tr>
						<tr>
							<th>상품이미지</th>
