...
public class Paging {
   ...
   private int startRow;      // 페이지당 시작번호 1~10 2~10 ... : 1
   private int endRow;         // 페이지당 끝 번호 1~10 2~10 ... : 10
   
   private int currentPage;	// 현재 페이지
   private int pageCount;	// 페이지 총 개수
   private int pageBlock;	// ex) 1~10 , 2~20 인 경우 10
   private int startPage;   // 페이지 블록당 시작 번호 1~10 : 1, 11~20 : 11
   private int endPage;    // 페이지 블록당 끝 번호 1~10 : 10, 11~20 : 20
